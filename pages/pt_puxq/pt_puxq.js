...
Page({
      ...
      success: function (res) {
        ...
        if (res.data.status === 100) {
          ...
          that.setData({
            ...
            detail: res.data.data.productDetails,
  ...
  goum:function(e){
    ...
    if(selectIndexArray.length === that.data.spec.length ){
      if (ds == true){
        wx.navigateTo({
        url: '../pt_tjdd/pt_tjdd?id=' + e.currentTarget.id + '&num=' + e.currentTarget.dataset.num
          + '&name=' + e.currentTarget.dataset.name + '&selectId=' + e.currentTarget.dataset.selectId
  ...
  //  if (selectIndexArray.length > [selectIndex] )
  //   wx.navigateTo({
  //     url: '../pt_tjdd/pt_tjdd?id=' + e.currentTarget.id + '&num=' + e.currentTarget.dataset.num ,
  //   })
  },
